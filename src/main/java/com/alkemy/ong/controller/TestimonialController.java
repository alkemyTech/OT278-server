...
/*
    @ApiOperation(value = "New Testimony", notes = "As an admin user you can save a new testimonial")
        @ApiResponses(value = {
...
*/
        @Operation(summary = "As an admin user you can save a new testimonial", description = "Return a new testimonial entity", responses = {
            @ApiResponse(responseCode = "201", description = "CREATED - Resource is fetched successfully", content = 
                @Content(schema = @Schema(implementation = TestimonialResponseDto.class))),
...
/*@Operation(description = "As an admin user you can save a new testimonial")
    @ApiResponses(value = {
        ...
        @ApiResponse(responseCode = "500", description = "Unable to save entity in the database.", content = {
